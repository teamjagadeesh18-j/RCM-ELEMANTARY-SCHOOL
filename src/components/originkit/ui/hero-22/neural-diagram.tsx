...
const NODES: Node[] = [
  {
    ...
    color: "#006bff",
    pill: { left: 85, top: 12, width: 150 },
    pillTablet: { left: 72, top: 73.5, width: 150 },
    pillDesktop: { left: 30, top: 40, width: 175 },
  ...
  },
  {
    ...
    pillTablet: { left: 58, top: 145, width: 140 },
    pillDesktop: { left: 20, top: 150, width: 160 },
  ...
  {
    label: "Moral & Character Care",
    color: "#8b5cf6",
    pill: { left: 165, top: 52, width: 145 },
    pillTablet: { left: 534, top: 156, width: 160 },
    pillDesktop: { left: 490, top: 110, width: 180 },
    ...
    connectorDesktop: { path: "M490 129H420L405 160" },
  },
];
...
export const NeuralDiagram = () => {
  ...
  return (
    <div className="w-full max-w-[680px] mx-auto flex items-center justify-center overflow-hidden py-2 shrink-0">
      <div
        ref={blockRef}
        className="relative w-full max-w-[680px] h-[340px] xs:h-[380px] sm:h-[420px] mx-auto overflow-hidden bg-transparent flex items-center justify-center scale-[0.85] xs:scale-95 sm:scale-100 origin-center transition-transform"
      >
      {/* Background arcs */}
      {ARCS.map((arc) => (
        <svg
      ...
      {ARC_DOTS.map((dot) => (
        <span
          key={dot.id}
          aria-hidden
          className="pointer-events-none absolute top-[var(--t-i)] left-[var(--l-i)] size-[9px] rounded-full border-[2px] border-solid border-white bg-[#006bff] shadow-sm desktop-sm:top-[var(--t-d)] desktop-sm:left-[var(--l-d)]"
          style={
            {
      ...
      <img
        ...
        alt="3D Brain Model"
        className={`${BOX_CLASS} pointer-events-none block max-w-none filter drop-shadow-[0_10px_20px_rgba(0,107,255,0.3)]`}
