...
const DEFAULT_COLORS = ["#006bff", "#0b3558", "#4795ff"];
...
export function PulsatingBorder({
  ...
  return (
    ...
    >
      ...
      <Tag
        {...tagProps}
        className="relative z-10 w-full h-full rounded-[inherit] bg-[#006bff] text-white px-8 py-3.5 font-bold text-base flex items-center justify-center transition-transform duration-200 group-hover:scale-[1.02] active:scale-[0.98]"
