...
export default function Testimonials13({
  ...
  return (
    <div className="px-6 py-20 max-w-7xl mx-auto overflow-hidden">
      <h2 className="text-[#0b3558]nter font-bold text-[#0b3558]xl tracking-tight md:text-[#0b3558]xl font-heading">
        {title}
      </h2>
      <p className="mt-3 text-[#0b3558]nter text-muted-foreground text-[#0b3558]se md:text-lg font-body max-w-2xl mx-auto">
        {subtitle}
      </p>
