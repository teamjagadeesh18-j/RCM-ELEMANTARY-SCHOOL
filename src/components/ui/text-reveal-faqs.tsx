...
export default function FAQs() {
  ...
  return (
    <section id="faqs" className="py-20 md:py-28 bg-[#f8f9fb] border-t border-[#d4e0ed] font-body relative overflow-hidden">
        ...
        <div className="grid gap-12 lg:grid-cols-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <TextEffect 
              ...
              speedReveal={1.1} 
              speedSegment={0.3} 
              className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#0b3558] font-heading tracking-tight leading-tight"
            >
            ...
            <div 
              ...
              style={{ borderColor: "#d4e0ed" }}
            >
              <h4 className="font-extrabold text-sm text-[#0b3558] font-heading">Need Direct Guidance?</h4>
          ...
          <div className="lg:col-span-7">
            <div 
              className="p-6 md:p-8 rounded-2xl bg-white border border-[#d4e0ed]"
              style={{
            ...
            >
              <Accordion type="single" collapsible className="space-y-3">
                {faqItems.map((item) => (
                  ...
                  >
                    <AccordionTrigger 
                      className="cursor-pointer text-left text-sm md:text-base font-extrabold text-[#0b3558] hover:no-underline font-heading py-4"
                    >
                      {item.question}
                    </AccordionTrigger>
