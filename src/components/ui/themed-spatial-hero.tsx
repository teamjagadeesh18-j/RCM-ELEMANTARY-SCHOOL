...
export function SpatialHeader() {
  return (
    <header className="sticky top-0 z-50 bg-[#f8f9fb]/90 backdrop-blur-md border-b border-[#d4e0ed] font-body">
      <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between text-sm text-[#0b3558]">
        <a href="/" className="hover:opacity-90 transition-opacity"><div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-[#006bff] text-white flex items-center justify-center font-bold font-heading shadow-sm">
            R
          </div>
          <div>
            <span className="font-bold text-base text-[#0b3558] font-heading tracking-tight block">
              R.C.M Matriculation Elementary School
            </span>
            <span className="text-[11px] text-[#476788] block -mt-1 font-medium">Matriculation Campus</span>
          </div>
        </div></a>
